 ...
 */
 void init_keys(){
	...
	keymap[0x47] = &home_pressed;
	keymap[0x48] = &cursor_up_pressed;
	keymap[0x49] = &page_up_pressed;
	keymap[0x4A] = &keypad_dash_pressed;
	keymap[0x4B] = &cursor_left_pressed;
	keymap[0x4C] = &keypad_5_pressed;
	keymap[0x4D] = &cursor_right_pressed;
	keymap[0x4E] = &keypad_plus_pressed;
	keymap[0x4F] = &end_pressed;
	keymap[0x50] = &cursor_down_pressed;
	keymap[0x51] = &page_down_pressed;
	keymap[0x52] = &insert_pressed;
	keymap[0x53] = &delete_pressed;
	...
	keymap[0xC8] = &cursor_up_released;
	keymap[0xC9] = &page_up_released;
	keymap[0xCA] = &keypad_dash_released;
	keymap[0xCB] = &cursor_left_released;
	keymap[0xCC] = &keypad_5_released;
	keymap[0xCD] = &cursor_right_released;
	keymap[0xCE] = &keypad_plus_released;
	keymap[0xCF] = &end_released;
	keymap[0xD0] = &cursor_down_released;
	keymap[0xD1] = &page_down_released;
	keymap[0xD2] = &insert_released;
	keymap[0xD3] = &page_down_released;
