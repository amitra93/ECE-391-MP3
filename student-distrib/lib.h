...
/* This is a test function to test interrupts generated by the RTC */
...
int32_t vprintf(terminal * term, int8_t *format, ...);
...
void clear(void);
void clear_line(unsigned char * video_memory, int32_t rownum);
